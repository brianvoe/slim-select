import{d as s,S as o,_ as a,o as i,c,a as e,f as t,e as v,r as h,b as r}from"./index.js";const q=s({name:"AlwaysOpen",mounted(){new o({select:this.$refs.alwaysOpenSingle,settings:{alwaysOpen:!0,contentLocation:this.$refs.alwaysOpenSingleContent,contentPosition:"relative"}}),new o({select:this.$refs.alwaysOpenMultiple,settings:{alwaysOpen:!0,contentLocation:this.$refs.alwaysOpenMultipleContent,contentPosition:"relative"}})}}),k={id:"alwaysOpen",class:"content"},I=e("h2",{class:"header"},"alwaysOpen",-1),R=e("p",null," alwaysOpen option is used to keep the select open at all times. This is useful for when you want to display the options at all times. ",-1),N={class:"row"},G={style:{height:"auto"}},U={ref:"alwaysOpenSingle"},Y=e("option",{value:"value1"},"Value 1",-1),W=e("option",{value:"value2"},"Value 2",-1),z=e("option",{value:"value3"},"Value 3",-1),F=[Y,W,z],J={ref:"alwaysOpenSingleContent"},K={style:{height:"auto"}},Q={ref:"alwaysOpenMultiple",multiple:""},X=e("option",{value:"value1"},"Value 1",-1),Z=e("option",{value:"value2"},"Value 2",-1),ee=e("option",{value:"value3"},"Value 3",-1),te=e("option",{value:"value4"},"Value 4",-1),oe=[X,Z,ee,te],le={ref:"alwaysOpenMultipleContent"},ne=e("pre",null,[t("      "),e("code",{class:"language-javascript"},`
    ...
    `)],-1);function Ga(l,n,u,d,p,_){return i(),c("div",Xs,[Zs,e("div",ea,[e("select",ta,sa,512),e("select",aa,da,512),e("select",pa,va,512),e("select",$a,wa,512)]),e("div",ba,[e("select",Va,Da,512),e("select",Oa,Ca,512),e("select",Ba,ja,512),e("select",Ha,Ra,512)]),Na])}const Ua=a(Qs,[["render",Ga]]),Ya=s({name:"Select"}),Wa={id:"select",class:"content"},za=e("h2",{class:"header"},"select",-1),Fa=e("p",null," The select field is used to identify the select element that will be used to create slim select. You can use any value you normally would in a querySelector or pass the element directly. ",-1),Ja=e("pre",null,[t("      "),e("code",{class:"language-javascript"},`
      ...
      `),t(`
    `)],-1),Ka=[za,Fa,Ja];function Qa(l,n,u,d,p,_){return i(),c("div",Wa,Ka)}const Xa=a(Ya,[["render",Qa]]),Za=s({name:"SelectAll",mounted(){new o({select:this.$refs.selectAll})}}),ei={id:"selectAll",class:"content"},ti=e("h2",{class:"header"},"selectAll",-1),oi=e("p",null," selectAll is a setting that can be used to add a select all action to an optgroup. This setting can be set to true or false. If set to true, a select all option will be added to the top of the selected values. If set to false or not set at all, no select all action will be added to the optgroup. ",-1),li=e("p",null,"selectAllText is a setting that can be used to change the text of the select all optgroup.",-1),ni=e("div",{class:"alert info"},"You can set selectAll/selectAllText either by data or by html dataset added to the optgroup element",-1),si={ref:"selectAll",multiple:""},ai=v('<optgroup label="Label 1" data-selectall="true" data-selectalltext="Select them all!"><option value="value1">Value 1</option><option value="value2">Value 2</option><option value="value3">Value 3</option></optgroup><optgroup label="Label 2"><option value="value4">Value 4</option><option value="value5">Value 5</option><option value="value6">Value 6</option></optgroup>',2),ii=[ai],ci=e("br",null,null,-1),ui=e("h3",null,"Via data",-1),di=e("pre",null,[t("      "),e("code",{class:"language-javascript"},`
        new SlimSelect({
          select: '#selectElement',
          data: [
            {
      ...
      `),t(`
    `)],-1),pi=e("br",null,null,-1),_i=e("h3",null,"Via html",-1),hi=e("pre",null,[t("      "),e("code",{class:"language-html"},`
      ...
      `),t(`
    `)],-1);function ri(l,n,u,d,p,_){return i(),c("div",ei,[ti,oi,li,ni,e("select",si,ii,512),ci,ui,di,pi,_i,hi])}const vi=a(Za,[["render",ri]]),$i=s({name:"ShowTooltip",mounted(){new o({select:this.$refs.showOptionTooltips,settings:{showOptionTooltips:!0}})}}),mi={id:"showOptionTooltips",class:"content"},gi=e("h2",{class:"header"},"showOptionTooltips",-1),fi=e("p",null," showOptionTooltips option is used to active displaying the on-hover tooltips for select options. The tooltip text is equal to the option text content. ",-1),wi={ref:"showOptionTooltips"},bi=e("option",{value:"value1"},"Value 1",-1),Vi=e("option",{value:"value2"},"Value 2",-1),Si=e("option",{value:"value3"},"Value 3",-1),yi=[bi,Vi,Si],xi=e("pre",null,[t("      "),e("code",{class:"language-javascript"},`
        new SlimSelect({
          select: '#selectElement',
          settings: {
      ...
      `),t(`
    `)],-1);function Di(l,n,u,d,p,_){return i(),c("div",mi,[gi,fi,e("select",wi,yi,512),xi])}const Oi=a($i,[["render",Di]]),Mi=s({name:"Styles",mounted(){new o({select:this.$refs.selectStyle}),new o({select:this.$refs.optionStyle})}}),Ti={id:"inlineStyles",class:"content"},Pi=e("h2",{class:"header"},"inline styles",-1),Ci=e("p",null," Slim select will inherit any styles that were added to the original select element. This includes options as well. ",-1),Bi={class:"row"},Li={ref:"selectStyle",style:{color:"red"}},Ai=e("option",{value:"value1"},"Value 1",-1),Ei=e("option",{value:"value2"},"Value 2",-1),ji=e("option",{value:"value3"},"Value 3",-1),Hi=[Ai,Ei,ji],qi={ref:"optionStyle"},ki=e("option",{style:{color:"red"},value:"value1"},"Red",-1),Ii=e("option",{style:{color:"green"}},"Green",-1),Ri=e("option",{style:{color:"blue"}},"Blue",-1),Ni=[ki,Ii,Ri],Gi=e("pre",null,[t("      "),e("code",{class:"language-html"},`
      ...
      `),t(`
    `)],-1);function Ui(l,n,u,d,p,_){return i(),c("div",Ti,[Pi,Ci,e("div",Bi,[e("select",Li,Hi,512),e("select",qi,Ni,512)]),Gi])}const Yi=a(Mi,[["render",Ui]]),Wi=s({name:"Settings",components:{Select:Xa,AlwaysOpen:ie,ContentLocation:tt,ContentPosition:St,OpenPosition:Ss,Placeholder:Ks,Deselect:Do,Display:Yo,Disabled:Pl,Mandatory:Wn,MinMax:ns,DataAttributes:lo,MaxValuesShown:dn,Css:Rt,Styles:Yi,Html:On,Search:Ua,CloseOnSelect:ke,ShowTooltip:Oi,SelectAll:vi,Closable:xe,HideSelected:Kl}}),zi={id:"settings",class:"contents"};function Fi(l,n,u,d,p,_){const $=h("Select"),m=h("AlwaysOpen"),g=h("ContentLocation"),f=h("ContentPosition"),w=h("OpenPosition"),b=h("Placeholder"),V=h("Deselect"),S=h("Display"),y=h("Disabled"),x=h("Mandatory"),D=h("MinMax"),O=h("DataAttributes"),M=h("Css"),T=h("Styles"),P=h("Html"),C=h("Search"),B=h("CloseOnSelect"),L=h("ShowTooltip"),A=h("SelectAll"),E=h("Closable"),j=h("HideSelected"),H=h("MaxValuesShown");return i(),c("div",zi,[r($),r(m),r(g),r(f),r(w),r(b),r(V),r(S),r(y),r(x),r(D),r(O),r(M),r(T),r(P),r(C),r(B),r(L),r(A),r(E),r(j),r(H)])}const Ki=a(Wi,[["render",Fi]]);export{Ki as default};
