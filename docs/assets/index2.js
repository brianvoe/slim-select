...
${JSON.stringify(s,null,2)}`}else this.message="❌ Please fill in all required fields"}}}),I={id:"required",class:"content"},D={class:"form-group"},L={id:"country-select",ref:"country",name:"country",required:""},O={class:"form-group"},B={id:"interests-select",ref:"interests",name:"interests",multiple:"",required:""},z={class:"form-group"},H={id:"priority-select",ref:"priority",name:"priority",required:""};function G(n,t,s,d,g,p){return u(),r("div",I,[t[8]||(t[8]=e("h2",{class:"header"},"Required Attribute",-1)),t[9]||(t[9]=e("p",null,[a("Use the "),e("code",null,"required"),a(" attribute for HTML5 form validation with SlimSelect")],-1)),e("form",{class:"required-form",onSubmit:t[0]||(t[0]=(...l)=>n.onSubmit&&n.onSubmit(...l))},[e("div",D,[t[2]||(t[2]=e("label",{for:"country-select"},"Country *",-1)),e("select",L,[...t[1]||(t[1]=[i('<option value="">Select a country</option><option value="usa">United States</option><option value="uk">United Kingdom</option><option value="canada">Canada</option><option value="australia">Australia</option><option value="germany">Germany</option>',6)])],512)]),e("div",O,[t[4]||(t[4]=e("label",{for:"interests-select"},"Interests * (Multiple)",-1)),e("select",B,[...t[3]||(t[3]=[i('<option value="sports">Sports</option><option value="music">Music</option><option value="technology">Technology</option><option value="travel">Travel</option><option value="reading">Reading</option><option value="art">Art</option>',6)])],512)]),e("div",z,[t[6]||(t[6]=e("label",{for:"priority-select"},"Priority *",-1)),e("select",H,[...t[5]||(t[5]=[i('<option value="">Select priority level</option><option value="low">Low</option><option value="medium">Medium</option><option value="high">High</option><option value="urgent">Urgent</option>',5)])],512)]),t[7]||(t[7]=e("button",{type:"submit",class:"button"},"Submit Form",-1)),n.message?(u(),r("div",{key:0,class:b(["message",n.message.includes("✅")?"success":"error"])},[e("pre",null,w(n.message),1)],2)):x("",!0)],32),t[10]||(t[10]=i(`<h3>HTML</h3><pre>      <code class="language-html">
    ...
    </pre><div class="alert"><p><strong>How it works:</strong> SlimSelect visually hides the original select element but keeps it focusable for native HTML5 validation. This means: </p><ul><li>✅ The <code>required</code> attribute works correctly</li><li>✅ Browser validation messages appear</li><li>✅ <code>form.checkValidity()</code> works as expected</li><li>✅ No console errors about unfocusable elements</li></ul></div>`,5))])}const J=m(K,[["render",G]]),W=c({name:"TextOverflow",data(){return{singleConstrained:null,placeholderConstrained:null,multipleConstrained:null}},mounted(){this.placeholderConstrained=new o({select:this.$refs.placeholderConstrained}),this.singleConstrained=new o({select:this.$refs.singleConstrained}),this.multipleConstrained=new o({select:this.$refs.multipleConstrained})}}),j={id:"textOverflow",class:"content"},Z={class:"constrained-container"},X={class:"form-group"},Y={ref:"placeholderConstrained"},Q={class:"constrained-container"},_={class:"form-group"},tt={ref:"singleConstrained"},et={class:"constrained-container"},nt={class:"form-group"},lt={ref:"multipleConstrained",multiple:""};function st(n,t,s,d,g,p){return u(),r("div",j,[t[6]||(t[6]=e("h2",{class:"header"},"Text Overflow Handling",-1)),t[7]||(t[7]=e("p",null," SlimSelect properly handles long text with ellipsis (...) to prevent layout issues when constrained by container width. ",-1)),t[8]||(t[8]=e("div",{class:"alert info"},[e("p",null,[e("strong",null,"Feature:"),a(" Text automatically truncates with ellipsis when it would overflow, ensuring the arrow/deselect buttons remain visible. ")])],-1)),t[9]||(t[9]=e("h3",null,"Placeholder Text - Constrained Width",-1)),e("div",Z,[e("div",X,[t[1]||(t[1]=e("label",null,"Select a very long placeholder option (250px max width)",-1)),e("select",Y,[...t[0]||(t[0]=[e("option",{value:"","data-placeholder":"true"}," Please choose from a very long list of available options that might exceed the container width ",-1),e("option",{value:"option1"},"Option 1",-1),e("option",{value:"option2"},"Option 2",-1),e("option",{value:"option3"},"Option 3",-1)])],512)])]),t[10]||(t[10]=e("h3",null,"Single Select - Constrained Width",-1)),e("div",Q,[e("div",_,[t[3]||(t[3]=e("label",null,"Country (250px max width)",-1)),e("select",tt,[...t[2]||(t[2]=[e("option",{value:"short"},"USA",-1),e("option",{value:"medium"},"United Kingdom",-1),e("option",{value:"long",selected:""},"Democratic People's Republic of Korea (North Korea)",-1),e("option",{value:"very-long"},"Lao People's Democratic Republic (Laos) - Southeast Asia",-1)])],512)])]),t[11]||(t[11]=e("h3",null,"Multiple Select - Constrained Width",-1)),e("div",et,[e("div",nt,[t[5]||(t[5]=e("label",null,"Features (250px max width)",-1)),e("select",lt,[...t[4]||(t[4]=[i('<option value="short" selected>AI</option><option value="medium" selected>Machine Learning</option><option value="long" selected>Natural Language Processing (NLP)</option><option value="very-long" selected>Computer Vision and Image Recognition Systems</option><option value="extremely-long">Deep Learning Neural Network Architecture Optimization</option>',5)])],512)])]),t[12]||(t[12]=i(`<h3>HTML</h3><pre>      <code class="language-html">
    ...
    </pre><div class="alert"><p><strong>How it works:</strong></p><ul><li>✅ Long text is truncated with ellipsis (...)</li><li>✅ Arrow and clear buttons stay visible</li><li>✅ No text wrapping or layout breaking</li><li>✅ Works in both single and multi-select modes</li><li>✅ Works for selected values and placeholder text</li><li>✅ Dropdown shows full text when opened</li></ul></div>`,5))])}const ot=m(W,[["render",st]]),it=c({name:"Examples",components:{Countries:T,FormReset:V,Required:J,TextOverflow:ot}}),at={id:"examples",class:"contents"};function rt(n,t,s,d,g,p){const l=h("Countries"),f=h("FormReset"),y=h("Required"),S=h("TextOverflow");return u(),r("div",at,[v(l),v(f),v(y),v(S)])}const ct=m(it,[["render",rt]]);export{ct as default};
