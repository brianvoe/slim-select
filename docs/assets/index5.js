import{d as v,S,_,o as r,c as m,m as f,r as g,a as t,f as o,t as h,b as s,w as a,j as b,n as O,e as C}from"./index.js";const y=v({name:"SlimSelect",props:{modelValue:{type:[String,Array,void 0]},multiple:{type:Boolean,default:!1},data:{type:Array},settings:{type:Object},events:{type:Object}},emits:["update:modelValue"],data(){return{slim:null}},mounted(){let e={select:this.$refs.slim};this.data&&(e.data=this.data),this.settings&&(e.settings=this.settings),this.events&&(e.events=this.events),e.events||(e.events={});const n=e.events.afterChange;e.events.afterChange=i=>{const d=this.multiple?i.map(c=>c.value):i.length>0?i[0].value:"";this.value!==d&&(this.value=d),e.events&&n&&n(i)},this.slim=new S(e);let p=this.$props.multiple?this.slim.getSelected():this.slim.getSelected()[0];this.value!==p&&this.slim.setSelected(this.value)},beforeUnmount(){this.slim&&this.slim.destroy()},watch:{modelValue:{handler:function(e){var n;(n=this.slim)==null||n.setSelected(this.getCleanValue(e))},immediate:!0},data:{handler:function(e){this.slim&&this.slim.setData(e)},deep:!0}},computed:{value:{get(){return this.getCleanValue(this.$props.modelValue)},set(e){this.$emit("update:modelValue",e)}}},methods:{getSlimSelect(){return this.slim},getCleanValue(e){const n=this.$props.multiple;return typeof e=="string"?n?[e]:e:Array.isArray(e)?n?e:e[0]:n?[]:""}}}),V=["multiple"];function w(e,n,p,i,d,c){return r(),m("select",{multiple:e.multiple,ref:"slim"},[f(e.$slots,"default")],8,V)}const $=_(y,[["render",w]]),D=v({name:"Vue",components:{SlimSelect:$},data(){return{simpleSingle:"2",simpleMultiple:["2","3"],settings:{showSearch:!1},data:[{value:"value1",text:"Value 1"},{value:"value2",text:"Value 2"},{value:"value3",text:"Value 3"}],afterChangeData:[],events:{afterChange:this.afterChange},isDisabled:!1,errorClass:""}},mounted(){},methods:{changeData(){this.$refs.dataSingle.getSlimSelect().open(),this.$refs.dataMultiple.getSlimSelect().open(),setTimeout(()=>{this.data=[{value:"value4",text:"Value 4"},{value:"value5",text:"Value 5"},{value:"value6",text:"Value 6"}]},500)},afterChange(e){this.afterChangeData=e}}}),q={id:"vue",class:"content"},k=t("h2",{class:"header"},"Vue",-1),j=t("h3",null,"Install",-1),M=t("p",null," The vue component is in a sub package under SlimSelect. All functionality still work in the implementation. I have also added a v-model bind capability to it as well. ",-1),A=t("pre",null,[o("      "),t("code",{class:"language-bash"},`
    ...
    </pre>`,9);function Qt(e,n,p,i,d,c){const l=g("SlimSelect");return r(),m("div",q,[k,j,M,A,T,B,t("div",N,[t("div",null,[t("div",null,[E,o(" "+h(e.simpleSingle),1)]),s(l,{modelValue:e.simpleSingle,"onUpdate:modelValue":n[0]||(n[0]=u=>e.simpleSingle=u),ref:"simpleSingle"},{default:a(()=>[I,U,R,z]),_:1},8,["modelValue"])]),t("div",null,[t("div",null,[H,o(" "+h(e.simpleMultiple),1)]),s(l,{modelValue:e.simpleMultiple,"onUpdate:modelValue":n[1]||(n[1]=u=>e.simpleMultiple=u),ref:"simpleMultiple",multiple:""},{default:a(()=>[Y,F,G]),_:1},8,["modelValue"])])]),J,K,L,P,Q,W,X,t("div",Z,[s(l,{settings:e.settings},{default:a(()=>[x,tt,et]),_:1},8,["settings"]),s(l,{settings:e.settings,multiple:""},{default:a(()=>[nt,ot,lt]),_:1},8,["settings"])]),st,it,at,ut,pt,dt,ct,rt,t("div",mt,[t("div",{class:"btn info",onClick:n[2]||(n[2]=(...u)=>e.changeData&&e.changeData(...u))},"Change data"),s(l,{ref:"dataSingle",data:e.data},null,8,["data"]),s(l,{ref:"dataMultiple",data:e.data,multiple:""},null,8,["data"])]),ht,vt,_t,gt,St,ft,bt,e.afterChangeData.length?(r(),m("div",Ot,[Ct,o(" "+h(e.afterChangeData),1)])):b("",!0),t("div",yt,[s(l,{events:e.events},{default:a(()=>[Vt,wt,$t]),_:1},8,["events"]),s(l,{events:e.events,multiple:""},{default:a(()=>[Dt,qt,kt]),_:1},8,["events"])]),jt,Mt,At,Tt,Bt,Nt,Et,It,t("div",Ut,[t("div",{class:"btn",onClick:n[3]||(n[3]=u=>e.isDisabled=!e.isDisabled)},"Toggle Disabled"),s(l,{disabled:e.isDisabled},{default:a(()=>[Rt,zt,Ht]),_:1},8,["disabled"])]),Yt,Ft,t("div",Gt,[t("div",{class:"btn",onClick:n[4]||(n[4]=u=>e.errorClass=e.errorClass===""?"error":"")},"Toggle Error"),s(l,{class:O(["dynamicClass",e.errorClass])},{default:a(()=>[Jt,Kt,Lt]),_:1},8,["class"])]),Pt])}const Wt=_(D,[["render",Qt]]),Xt=v({name:"Events",components:{Vue:Wt}}),Zt={id:"frameworks",class:"contents"};function xt(e,n,p,i,d,c){const l=g("Vue");return r(),m("div",Zt,[s(l)])}const ee=_(Xt,[["render",xt]]);export{ee as default};
