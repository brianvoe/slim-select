import{d as _,S as a,_ as g,o as r,c as i,f as s,t as d,i as v,a as e,F as V,j as O,k as y,O as x,r as p,b as f}from"./index.js";const M=_({name:"Error",data(){return{errorSingle:null,errMsg:""}},mounted(){this.errorSingle=new a({select:this.$refs.errorSingle,events:{error:t=>{this.errMsg=t.message}}})}}),k={id:"error",class:"content"},A=e("h2",{class:"header"},"error",-1),F=e("p",null,"The error event is fired when an error occurs. The error message is passed as the first argument.",-1),j=e("div",{class:"alert info"}," If you are are having issues with slim select finding the select element. Try delaying new SlimSelect() call as the select dom element might not be available yet. ",-1),T={key:0},E=e("b",null,"Error:",-1),B={class:"row"},L={ref:"notError"},D=e("option",{value:"1"},"Option 1",-1),P=e("option",{value:"2"},"Option 2",-1),N=e("option",{value:"3"},"Option 3",-1),H=[D,P,N],R=e("pre",null,[s("      "),e("code",{class:"language-javascript"},`
    ...
    `)],-1),he={id:"afterChange",class:"content"},ue=e("h2",{class:"header"},"afterChange",-1),de=e("p",null,"afterChange will trigger a callback after the value of the select dropdown has changed.",-1),_e={key:0},pe={ref:"afterChangeSingle"},fe=e("option",{"data-placeholder":"true"},"Select Option",-1),ge=e("option",{value:"value1"},"Value 1",-1),ve=e("option",{value:"value2"},"Value 2",-1),me=e("option",{value:"value3"},"Value 3",-1),$e=[fe,ge,ve,me],be=e("br",null,null,-1),Se={key:1},Ce={ref:"afterChangeMultiple",multiple:""},we=e("option",{value:"value1",selected:""},"Value 1",-1),Oe=e("option",{value:"value2"},"Value 2",-1),Ve=e("option",{value:"value3"},"Value 3",-1),ye=[we,Oe,Ve],xe=e("pre",null,[s("      "),e("code",{class:"language-javascript"},`
      ...
      `),s(`
    `)],-1);function Me(t,n,c,h,u,o){return r(),i(V,null,[e("div",z,[q,G,K,t.beforeChangeSingle?(r(),i("div",Q,[e("strong",null,"Before change: "+d(t.beforeChangeSingle),1)])):v("",!0),e("select",W,te,512),ne,t.beforeChangeMultiple?(r(),i("div",se,[e("strong",null,"Before change: "+d(t.beforeChangeMultiple),1)])):v("",!0),e("select",oe,ie,512),ce]),e("div",he,[ue,de,t.afterChangeSingle?(r(),i("div",_e,[e("strong",null,"After change: "+d(t.afterChangeSingle),1)])):v("",!0),e("select",pe,$e,512),be,t.afterChangeMultiple?(r(),i("div",Se,[e("strong",null,"After change: "+d(t.afterChangeMultiple),1)])):v("",!0),e("select",Ce,ye,512),xe])],64)}const ke=g(U,[["render",Me]]),Ae=_({name:"BeForeAfterOpenClose",data(){return{beforeAfterOpenCloseSingle:null,singleState:"",beforeAfterOpenCloseMultiple:null,multipleState:""}},mounted(){this.beforeAfterOpenCloseSingle=new a({select:this.$refs.beforeAfterOpenCloseSingle,events:{beforeOpen:()=>{this.setState("single","beforeOpen")},afterOpen:()=>{this.setState("single","afterOpen")},beforeClose:()=>{this.setState("single","beforeClose")},afterClose:()=>{this.setState("single","afterClose")}}}),this.beforeAfterOpenCloseMultiple=new a({select:this.$refs.beforeAfterOpenCloseMultiple,events:{beforeOpen:()=>{this.setState("multiple","beforeOpen")},afterOpen:()=>{this.setState("multiple","afterOpen")},beforeClose:()=>{this.setState("multiple","beforeClose")},afterClose:()=>{this.setState("multiple","afterClose")}}})},methods:{setState(t,n){t==="single"?this.singleState=n:this.multipleState=n,setTimeout(()=>{t==="single"?this.singleState="":this.multipleState=""},1e3)}}}),Fe={id:"open",class:"content"},je=e("h2",{class:"header"},"beforeOpen / afterOpen / beforeClose / afterClose",-1),Te=e("p",null," The beforeOpen, afterOpen, beforeClose, and afterClose events will fire before and after the select is opened and closed. ",-1),Ee={class:"row"},Be={ref:"beforeAfterOpenCloseSingle"},Le=e("option",{value:"value1"},"Value 1",-1),De=e("option",{value:"value2"},"Value 2",-1),Pe=e("option",{value:"value3"},"Value 3",-1),Ne=[Le,De,Pe],He={ref:"beforeAfterOpenCloseMultiple",multiple:""},Re=e("option",{value:"value1"},"Value 1",-1),Ie=e("option",{value:"value2"},"Value 2",-1),Je=e("option",{value:"value3"},"Value 3",-1),Ue=[Re,Ie,Je],ze=e("pre",null,[s("      "),e("code",{class:"language-javascript"},`
        var select = new SlimSelect({
          select: '#selectElement',
          events: {
            beforeOpen: () => {
    ...
    `)],-1);function vt(t,n,c,h,u,o){return r(),i("div",tt,[nt,st,ot,e("div",at,[e("select",lt,ht,512),e("select",ut,ft,512)]),gt])}const mt=g(et,[["render",vt]]),$t=_({name:"Addable",mounted(){new a({select:this.$refs.addableSingle,events:{addable:t=>({text:t,value:t.toLowerCase()})}}),new a({select:this.$refs.addableMultiple,events:{addable:t=>new Promise(n=>{setTimeout(()=>{n({text:t,value:t})},100)})}})}}),bt={id:"addable",class:"content"},St=e("h2",{class:"header"},"addable",-1),Ct=e("p",null,"Slim select has the ability to dynamically add options via the search input field",-1),wt=e("p",null," addable is a callback which takes a function parameter. The return value can either be a string or an option object. ",-1),Ot={class:"row"},Vt={ref:"addableSingle"},yt=e("option",{value:"value1"},"Value 1",-1),xt=e("option",{value:"value2"},"Value 2",-1),Mt=e("option",{value:"value3"},"Value 3",-1),kt=[yt,xt,Mt],At={ref:"addableMultiple",multiple:""},Ft=e("option",{value:"value1"},"Value 1",-1),jt=e("option",{value:"value2"},"Value 2",-1),Tt=e("option",{value:"value3"},"Value 3",-1),Et=[Ft,jt,Tt],Bt=e("pre",null,[s("      "),e("code",{class:"language-javascript"},`
      ...
      `),s(`
    `)],-1);function Lt(t,n,c,h,u,o){return r(),i("div",bt,[St,Ct,wt,e("div",Ot,[e("select",Vt,kt,512),e("select",At,Et,512)]),Bt])}const Dt=g($t,[["render",Lt]]),Pt=_({name:"Events",components:{Error:J,BeforeAfterChange:ke,BeforeAfterOpenClose:Ge,Search:Ze,SearchFilter:mt,Addable:Dt}}),Nt={id:"events",class:"contents"};function Ht(t,n,c,h,u,o){const m=p("Error"),S=p("BeforeAfterChange"),$=p("BeforeAfterOpenClose"),b=p("Search"),C=p("SearchFilter"),l=p("Addable");return r(),i("div",Nt,[f(m),f(S),f($),f(b),f(C),f(l)])}const It=g(Pt,[["render",Ht]]);export{It as default};
