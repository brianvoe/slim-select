import{d as _,S as a,_ as g,o as r,c as i,f as s,t as d,j as v,a as e,F as V,k as O,l as y,O as x,r as p,b as f}from"./index.js";const M=_({name:"Error",data(){return{errorSingle:null,errMsg:""}},mounted(){this.errorSingle=new a({select:this.$refs.errorSingle,events:{error:t=>{this.errMsg=t.message}}})}}),A={id:"error",class:"content"},k=e("h2",{class:"header"},"error",-1),F=e("p",null,"The error event is fired when an error occurs. The error message is passed as the first argument.",-1),j=e("div",{class:"alert info"}," If you are are having issues with slim select finding the select element. Try delaying new SlimSelect() call as the select dom element might not be available yet. ",-1),T={key:0},E=e("b",null,"Error:",-1),B={class:"row"},L={ref:"notError"},D=e("option",{value:"1"},"Option 1",-1),P=e("option",{value:"2"},"Option 2",-1),N=e("option",{value:"3"},"Option 3",-1),R=[D,P,N],H=e("pre",null,[s("      "),e("code",{class:"language-javascript"},`
    ...
    `)],-1);function vt(t,n,c,h,u,o){return r(),i("div",tt,[nt,st,ot,e("div",at,[e("select",lt,ht,512),e("select",ut,ft,512)]),gt])}const mt=g(et,[["render",vt]]),$t=_({name:"Addable",mounted(){new a({select:this.$refs.addableSingle,events:{addable:t=>({text:t,value:t.toLowerCase()})}}),new a({select:this.$refs.addableMultiple,events:{addable:t=>new Promise(n=>{setTimeout(()=>{n({text:t,value:t})},100)})}})}}),bt={id:"addable",class:"content"},St=e("h2",{class:"header"},"addable",-1),Ct=e("p",null,"Slim select has the ability to dynamically add options via the search input field",-1),wt=e("p",null," addable is a callback which takes a function parameter. The return value can either be a string or an option object. ",-1),Ot={class:"row"},Vt={ref:"addableSingle"},yt=e("option",{value:"value1"},"Value 1",-1),xt=e("option",{value:"value2"},"Value 2",-1),Mt=e("option",{value:"value3"},"Value 3",-1),At=[yt,xt,Mt],kt={ref:"addableMultiple",multiple:""},Ft=e("option",{value:"value1"},"Value 1",-1),jt=e("option",{value:"value2"},"Value 2",-1),Tt=e("option",{value:"value3"},"Value 3",-1),Et=[Ft,jt,Tt],Bt=e("pre",null,[s("      "),e("code",{class:"language-javascript"},`
      ...
      `),s(`
    `)],-1);function Lt(t,n,c,h,u,o){return r(),i("div",bt,[St,Ct,wt,e("div",Ot,[e("select",Vt,At,512),e("select",kt,Et,512)]),Bt])}const Dt=g($t,[["render",Lt]]),Pt=_({name:"Events",components:{Error:J,BeforeAfterChange:Ae,BeforeAfterOpenClose:Ge,Search:Ze,SearchFilter:mt,Addable:Dt}}),Nt={id:"events",class:"contents"};function Rt(t,n,c,h,u,o){const m=p("Error"),S=p("BeforeAfterChange"),$=p("BeforeAfterOpenClose"),b=p("Search"),C=p("SearchFilter"),l=p("Addable");return r(),i("div",Nt,[f(m),f(S),f($),f(b),f(C),f(l)])}const It=g(Pt,[["render",Rt]]);export{It as default};
