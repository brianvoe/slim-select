  ...
  },
  {
    getSlimSelect(): {
      ...
      store: {
        ...
        ) => import('../slim-select/store').DataArray
        filter: (
        ...
        callbacks: {
          ...
          addable?:
            | ((
                ...
                | string
                | false
                | import('../slim-select/store').OptionOptional
                | Promise<string | import('../slim-select/store').OptionOptional>
                | null
                | undefined)
            | undefined
      ...
      events: {
        search?:
          | ((
              searchValue: string,
              currentData: import('../slim-select/store').DataArray,
            ) => DataArrayPartial | Promise<DataArrayPartial>)
          | undefined
