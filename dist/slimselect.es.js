...
function m(e) {
	if (e.labels && e.labels.length > 0) {
		let t = Array.from(e.labels).map(p).filter(Boolean);
...
function C(e, t) {
	for (let n of y) if (x(e, n) !== x(t, n)) return !1;
	return b(e.data || {}, t.data || {});
}
function w(e, t) {
	let n = (e) => ({
		id: e.id || "",
	...
	for (let e = 0; e < a.length; e++) if (!C(a[e], o[e])) return !1;
	return !0;
}
function T(e, t) {
	if (e === t) return !0;
...
function D(e, t = typeof window < "u" ? window.innerWidth : 768) {
...
var O = class {
	...
	mandatory;
	constructor(e) {
		this.id = !e.id || e.id === "" ? h() : e.id, this.value = e.value === void 0 ? e.text || "" : e.value || "", this.text = e.text || "", this.html = e.html || "", this.defaultSelected = e.defaultSelected !== void 0 && e.defaultSelected, this.selected = e.selected !== void 0 && e.selected, this.display = e.display === void 0 || e.display, this.disabled = e.disabled !== void 0 && e.disabled, this.mandatory = e.mandatory !== void 0 && e.mandatory, this.placeholder = e.placeholder !== void 0 && e.placeholder, this.class = e.class || "", this.style = e.style || "", this.data = f(e.data);
	}
}, j = class {
	id;
	label;
	...
	options;
	constructor(e) {
		if (this.id = !e.id || e.id === "" ? h() : e.id, this.label = e.label || "", this.selectAll = e.selectAll !== void 0 && e.selectAll, this.closable = e.closable || "off", this.options = [], e.options) for (let t of e.options) this.options.push(new A(t));
	}
}, M = class {
	selectType = "single";
	data = [];
	...
	setSelectedBy(e, t, n = !1) {
		...
		for (let n of this.data) {
			...
			n instanceof A && (r ||= n, n.selected = !i && t.includes(n[e]), n.selected && (a.push(n), this.selectType === "single" && (i = !0)));
		}
	...
	getSelectedOptions() {
		let e = [];
		for (let t of this.data) if (t instanceof j) for (let n of t.options) n.selected && e.push(n);
	...
	getOptionByID(e) {
		for (let t of this.data) if (t instanceof j) {
	...
	resolveModalView() {
		return this.settings.alwaysOpen || this.settings.modal === "off" || !this.modalElements ? !1 : (this.modalSessionActive === null && (this.modalSessionActive = D(this.settings.modal)), this.modalSessionActive);
	}
	createModalElements() {
	...
	searchDiv() {
		...
		let r = {
			main: e,
			input: t
		}, a = this.settings.selectAll && this.settings.isMultiple;
		this.settings.showSearch || (t.readOnly = !0, a ? this.addClasses(t, this.classes.hide) : this.addClasses(e, this.classes.hide)), t.type = "search", t.id = `${this.settings.id}-search`, t.placeholder = this.settings.searchPlaceholder, t.tabIndex = -1, t.setAttribute("aria-label", this.settings.searchPlaceholder), t.setAttribute("aria-autocomplete", "list"), t.setAttribute("autocapitalize", "off"), t.setAttribute("autocomplete", "off"), t.setAttribute("autocorrect", "off"), t.setAttribute("aria-hidden", "true");
		let o = _(() => {
			this.callbacks.search(t.value);
		}, 100);
		if (t.oninput = (e) => {
			e.target.value !== "" && this.clearValueChipHighlight(), o();
		}, t.onkeydown = (e) => {
			switch (e.key) {
				case "ArrowUp":
...
var F = class {
	...
	createOption(e) {
		...
		return t.id = e.id, t.value = e.value, t.textContent = e.text, e.html !== "" && t.setAttribute("data-html", e.html), t.defaultSelected = e.defaultSelected, t.selected = e.selected, e.disabled && (t.disabled = !0), t.hidden = !e.display, e.placeholder && t.setAttribute("data-placeholder", "true"), e.mandatory && t.setAttribute("data-mandatory", "true"), e.class && e.class.split(" ").forEach((e) => {
			...
			t.setAttribute("data-" + E(n), e.data[n]);
		}), t;
	}
	setupLabelHandlers() {
		...
		Array.from(new Set(e)).forEach((e) => {
			...
			let t = (e) => {
				let t = e.target, n = g(t, this.select.dataset.id);
...
var R = class {
	...
	constructor(t) {
		...
		this.selectEl.dataset.ssid && this.destroy(), this.settings = new d(t.settings), t.settings?.selectAll === void 0 && this.selectEl.dataset.selectall === "true" && (this.settings.selectAll = !0), this.cssClasses = new e(t.cssClasses);
		let n = [
			"beforeOpen",
			"afterOpen",
			"afterClose"
